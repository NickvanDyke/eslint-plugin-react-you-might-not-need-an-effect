...
| `no-adjust-some-state-when-a-prop-changes` | Disallow adjusting some state when a prop changes in an effect. | [docs](https://react.dev/learn/you-might-not-need-an-effect#adjusting-some-state-when-a-prop-changes) |
